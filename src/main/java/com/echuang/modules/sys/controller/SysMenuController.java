...
public class SysMenuController extends AbstractController {
    ...
    public ResultResponse nav() {
        ...
        return ResultResponse.ok().put("menuList", menuList).put("permissions", permissions);
    }
    ...
    public ResultResponse select() {
        ...
        return ResultResponse.ok().put("menuList", menuList);
    }
    ...
    public ResultResponse info(@PathVariable("menuId") Long menuId) {
        ...
        return ResultResponse.ok().put("menu", menu);
    }
    ...
    public ResultResponse save(@RequestBody SysMenuEntity menu) {
        //数据校验
        verifyForm(menu);
    ...
    public ResultResponse update(@RequestBody SysMenuEntity menu) {
        //数据校验
        verifyForm(menu);
